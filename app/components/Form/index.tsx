      ...
      >
        ...
        <div>
          ...
          <input
            ...
            id="name"
            type="text"
            className={`custom-input form-control ${errors.name ? "is-invalid" : ""}`}
          />
        ...
        <div>
          ...
          <input
            ...
            id="email"
            type="email"
            className={`custom-input form-control ${errors.email ? "is-invalid" : ""}`}
          />
        ...
        <div>
          ...
          <input
            ...
            id="phone"
            type="tel"
            className={`custom-input form-control ${errors.phone ? "is-invalid" : ""}`}
          />
...
// Updated ErrorInput component
interface ErrorInputProps {
  error?: FieldError; // Updated to specify that error can be FieldError or undefined
}

const ErrorInput: React.FC<ErrorInputProps> = ({ error }) => {
  return (
    <>
      {error && (
